...
mise run test-sidecar     # sidecar 测试
mise run test-sidecar -- tests/test_ranking.py   # 单文件
mise run lint-sidecar     # sidecar 代码风格检查（ruff）
mise run localscore-sidecar -- /path/to/img.jpg   # 对单张图跑层①评分并打印明细（调试/标定）
```
